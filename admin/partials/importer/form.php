...
<div class="wrap woocommerce">
    <h1 class="wp-heading-inline">WooCommerce & Trader Integration</h1>
    ...
    <div class="woocommerce-progress-form-wrapper">
        <form id="jt-trader-importer" class="wc-progress-form-content woocommerce-importer jt-trader-importer" enctype="multipart/form-data" method="post">
            <header>
                <h2><?php esc_html_e( 'Import products from Trader', 'woocommerce' ); ?></h2>
            </header>
